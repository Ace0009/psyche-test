...
<head>
    ...
    <title>Psyche Admin Dashboard</title>
...
<div class="wrapper">
    ...
    <div class="sidebar" data-active-color="rose" data-background-color="black"
        ...
        <div class="sidebar-wrapper">
            <div class="user">
                <div class="photo">
                    <img class="img" src="{{ Auth::user()->avatar }}" alt="{{ Auth::user()->name }}"/>
                </div>
                <div class="info">
                        ...
                        <ul class="nav">
                            <li>
                                <a href="#" >
                                    ...
                                    <span class="sidebar-normal"> {{ Auth::user()->email }} </span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('logout') }}"
            ...
            <ul class="nav">
                ...
                <li class="@if(str_contains(url()->current(), '/counselors')) active @endif">
                    <a href="{{ url('admin/counselors') }}">
